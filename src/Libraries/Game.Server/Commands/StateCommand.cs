...
public class StateCommand : ICommandHandler
{
    public Task ExecuteAsync(CommandContext context)
    {
        ...
        context.Player.SendChatInfo($"HP {p.Health}/{context.Player.GetPoint(EPoint.MaxHp)}");
        context.Player.SendChatInfo($"SP {p.Mana}/{context.Player.GetPoint(EPoint.MaxSp)}");
